        ...
        try {
            ...
            return [
                ...
                'metrics' => [
                    ...
                    'open_balance_variation' => $data['open_close']->open_balance_variation,
                    'income_variation' => $data['open_close']->income_variation,
                    'expensive_variation' => $data['open_close']->expensive_variation,
                    'utility_variation' => $data['open_close']->utility_variation,
                ],
                'init_date' => $init_date,
                'end_date' => $end_date,
